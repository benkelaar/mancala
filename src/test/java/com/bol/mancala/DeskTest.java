...
public class DeskTest {
    ...
    public void testOppositePitIdxShouldBeOK(){
        // ordinal pits
        assertEquals(7, desk.getOppositePit(0));
        assertEquals(0, desk.getOppositePit(7));
    ...
    public void testLastSeedInEmptyPitShouldCaptureSeeds() {
        ...
        assertEquals(3, desk.getBasket(0));
        assertEquals(0, desk.getBasket(1));
        assertEquals(0, desk.getSeeds(1, 2));
    }
